    ...
    <ScienceShell title="about">
      ...
      <ul>
        ...
        <li>
          ...
          <Link href="https://psychology.ku.edu/people/emma-muller">Emma Muller</Link> revealed to me the joy and importance of doing science with
          and for one&apos;s community.
        </li>
      </ul>
    </ScienceShell>
  );
